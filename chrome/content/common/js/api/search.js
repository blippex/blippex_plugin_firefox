blippex.define('blippex.api.search', {
	...
	sendMessage: function(sender, request){
    ...
    xhr.open('GET', 'chrome://blippex/content/common/css/overlay.css', false);
    xhr.send();
		blippex.api.search.css = xhr.responseText;
	},
	search: function(oArgs) {
		if (blippex.browser.settings.get('google')) {
			...
			blippex.content.google.sendMessage(oArgs.tab, {
				'type': 'search',
